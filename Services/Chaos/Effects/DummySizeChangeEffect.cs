    ...
    public class DummySizeChangeEffect : IChaosEffect
    {
        ...
        public void OnStart()
        {
            ...
            if (_playerTransform != null)
            {
                ...
                _playerTransform.localScale = _originalScale * _growthScale;
                MegaChaos.Main.Msg("[MegaChaos] Player size tripled!");
                ApplySpeedModifier(1f / _growthScale);
                _scaleApplied = true;
            }
            else
            {
        ...
        private void TryRemoveSpeedModifier()
        {
            ...
            try
            {
                ...
                if (!removed)
                {
                    ...
                    GameReflection.SetMember(invMod, "modification", _growthScale);
